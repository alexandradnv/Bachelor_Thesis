...
#SBATCH --job-name=blind-earth-fewshot-gt-olmo32b
...
#SBATCH --output=logs/blind_earth_fewshot_gt_olmo32b_%j.log
#SBATCH --error=logs/blind_earth_fewshot_gt_olmo32b_%j.err
#SBATCH --chdir=/ceph/adinchev/experiment

# Few-shot ground-truth, allenai/Olmo-3.1-32B-Instruct (full precision, TP=2).
