...
#SBATCH --job-name=blind-earth-fewshot-gt-qwen72b-awq
...
#SBATCH --output=logs/blind_earth_fewshot_gt_qwen72b_awq_%j.log
#SBATCH --error=logs/blind_earth_fewshot_gt_qwen72b_awq_%j.err
#SBATCH --chdir=/ceph/adinchev/experiment

# Few-shot ground-truth, Qwen/Qwen2.5-72B-Instruct-AWQ.
# 72B AWQ is ~40 GB; tight on 1×48 GB once KV cache is allocated,
# so we use TP=2 for headroom.
