#!/bin/bash
#SBATCH --job-name=blind-earth-gt-anc-qwen32b-awq
...
#SBATCH --output=logs/blind_earth_gt_anc_qwen32b_awq_%j.log
#SBATCH --error=logs/blind_earth_gt_anc_qwen32b_awq_%j.err
#SBATCH --chdir=/ceph/adinchev/experiment

# Few-shot ground-truth + Mannheim anchor, Qwen/Qwen2.5-32B-Instruct-AWQ (TP=1).
...
echo "Starting GT+anchor (Qwen2.5-32B-Instruct-AWQ, TP=1)  at $(date)"
